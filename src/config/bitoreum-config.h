/* src/config/bitoreum-config.h.  Generated from bitoreum-config.h.in by configure.  */
/* src/config/bitoreum-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BITOREUM_CONFIG_H

#define BITOREUM_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitoreum Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitoreum Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bugahost/bitoreum/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitoreum Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitoreum Core 1.3.17"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitoreumcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitoreum.org/"
